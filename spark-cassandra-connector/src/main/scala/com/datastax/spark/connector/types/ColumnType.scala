...
object ColumnType {
  ...
  private lazy val customFromDriverRow: PartialFunction[(DataType, DataType.Name), ColumnType[_]] = {
    Option(System.getenv("SPARK_CASSANDRA_CONNECTOR_CUSTOM_DRIVER_CONVERTER"))
      .orElse(Option(System.getProperty("SPARK_CASSANDRA_CONNECTOR_CUSTOM_DRIVER_CONVERTER")))
  ...
  def fromDriverType(dataType: DataType): ColumnType[_] = {
    ...
    val getColumnType = customFromDriverRow orElse {
